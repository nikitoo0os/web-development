...
describe('ShoeCareService', () => {
  ...
  describe('#getAllShoeCare$Response', () => {
    it('should return an Observable<StrictHttpResponse<Array<ShoeCare>>>', () => {
      ...
      service.getAllShoeCare$Response().subscribe((res) => {
        expect(res.body).toEqual(dummyShoeCare);
      });
